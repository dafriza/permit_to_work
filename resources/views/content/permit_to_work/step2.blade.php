        ...
        <div class="card mb-4">
            <div class="hstack gap-3">
                ...
                <div class="p-2 ms-auto">
                    <h4 style="text-align: center">PERMIT TO WORK <br>
                        <h5 style="text-align: center">TRA</h5>
                    </h4>
                </div>
                <div class="p-2 ms-auto">
                </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="table-responsive text-nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input class="form-check-input-inline" type="checkbox"
                                                                name="accountActivation" id="accountActivation"></td>
                                                        <td>
                                                            <div class="p-3">25. Bad Weather <br><i>Cuaca Buruk</i>
                                                            </div>
                                                        </td>
                                                    </tr>
                                            ...
                                            <div class="row g-0 text-center">
                                                <div class="col-6 col-md-4" style="padding-top: 15px">
                                                    Hazards (Other) / Bahaya - bahaya Lain </div>
