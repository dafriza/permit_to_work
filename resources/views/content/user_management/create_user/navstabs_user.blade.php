<ul class="nav nav-tabs" id="userManagement" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="role-create-tab" data-bs-toggle="tab" data-bs-target="#role-create" type="button"
            role="tab" aria-controls="role-create" aria-selected="false">User Role</button>
    </li>
</ul>
