                ...
                <button id="submit_permit_to_work" class="btn btn-primary me-2 disabled">Submit</button>
                    ...
                    <!-- Basic with Icons -->
                                <form>
                                            ...
                                            <div class="table-responsive text-nowrap">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <!-- Row 2 -->
                                                        <tr>
                                                            <th scope="row"><input class="form-check-input-inline"
                                                                    type="checkbox" name="accountActivation"
                                                                    id="accountActivation"></th>
                                                            <td>
                                        ...
                                        {{-- Hazard input --}}
                                        <div class="form-check mb-3">
                                                <label class="form-check-label d-flex justify-content-left mt-3" for="Hazards">Hazards (Other) / Bahaya - bahaya Lain</label>
                                                <div class="mb-3 col-md-12" id="dynamicInputContainer">
                                                    <div class="input-group mb-3">
                                                        <input class="form-control" type="text" name="Hazards[]" placeholder="Air Laut Pasang" />
                        ...
                        <div class="form-check mb-3">
                            <label class="form-check-label d-flex justify-content-left mt-3" for="ControlOther">Control (Other) / Pengendalian (Lain-lain)</label>
                            <div class="mb-3 col-md-12" id="dynamicInputContainerControlOther">
                                <div class="input-group mb-3">
                                    ...
                                    <button class="btn btn-primary" type="button" onclick="addInputFieldControlOther()">+</button>
                                </div>
                            </div>
                        </div>
                        <div class="form-check mb-3">
                            <label class="form-check-label d-flex justify-content-left mt-3" for="AdditionalPPE">Additional PPE / APD Tambahan</label>
                            <div class="mb-3 col-md-12" id="dynamicInputContainerAdditionalPPE">
                                <div class="input-group mb-3">
                                    ...
                                    <button class="btn btn-primary" type="button" onclick="addInputFieldAdditionalPPE()">+</button>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="p-10">Equipment Depressurised <br><i>Pengosongan tekanan pada alat</i></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-check-input-inline" type="checkbox"
                                                                    name="accountActivation" id="accountActivation">
