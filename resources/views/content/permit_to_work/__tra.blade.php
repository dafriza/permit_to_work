                ...
                <div class="container text-center">
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="p-10">6. Tripping Hazard <br><i>Bahaya Tersandung</i>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-check-input-inline" type="checkbox"
                                                name="accountActivation" id="accountActivation"></td>
                                        <td>
                                            <div class="p-10">7. Lifting > 10 tons <br><i>Pengangkatan > 10
                                                    ton</i>
                                            </div>
                                        </td>
                                        <td><input class="form-check-input-inline" type="checkbox"
                                        ...
                                        <td><input class="form-check-input-inline" type="checkbox"
                                                name="accountActivation" id="accountActivation"></td>
                                        <td>
                                            <div class="p-10">17. Pressurized Hose Failure <br><i>Kegagalan
                                                    Selang
                                                    Bertekanan</i></div>
                                        </td>
                                        <td><input class="form-check-input-inline" type="checkbox"
                            ...
                            <div class="row g-0 text-center">
                                <div class="col-6 col-md-4" style="padding-top: 15px">Hazards(Other)/Bahaya -
                                    bahaya
                                    Lain </div>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive text-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="p-10">No electrical enclosure containing live
                                                ...
                                                <i>Jangan meninggalkan peralatan yang masih beraliran listrik
                                                    begitu
                                                    saja</i>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="p-10">Rubber gloves for appropriate voltage
                                                provided<br>
                                                <i>Gunakan sarung tangan karet sesuai dengan tegangan listrik
                                                    yang
                                                    ditangani</i>
                                            </div>
                                        </td>
                            ...
                            <p></p>
                            <div class="row g-0 text-center">
                                <div class="col-6 col-md-4" style="padding-top: 15px">Controls (Other) /
                                    Pengendalian
                                    (Lain-lain) </div>
                                <!-- Text Area bisa diisi pake Select kalau Memungkinkan -->
                                <textarea class="col-sm-6 col-md-8"></textarea>
                            ...
                            <p></p>
                            <div class="row g-0 text-center">
                                <div class="col-6 col-md-4" style="padding-top: 15px">Additional PPE / APD
                                    Tambahan
                                </div>
                                <!-- Text Area bisa diisi pake Select kalau Memungkinkan -->
                                <textarea class="col-sm-6 col-md-8"></textarea>
