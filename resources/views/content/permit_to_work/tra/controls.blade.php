...
<div class="card">
    ...
    <div class="table-responsive text-nowrap">
        <table class="table table-bordered table-sm controls">
            <tbody>
                {{-- Step 1 --}}
                <tr>
                    <th scope="row">
...
<div class="form-check mb-3">
    <label class="form-check-label d-flex justify-content-left mt-3" for="ControlOther">Control
        (Other) /
    ...
    <div class="mb-3 col-md-12" id="dynamicInputContainerControlOther">
        <div class="input-group mb-3">
            ...
            <textarea id="control_other" class="form-control" name="controls_other"></textarea>
...
<div class="form-check mb-3">
    <label class="form-check-label d-flex justify-content-left mt-3" for="AdditionalPPE">Additional
        PPE /
        APD Tambahan</label>
    <div class="mb-3 col-md-12" id="dynamicInputContainerAdditionalPPE">
        <div class="input-group mb-3">
            ...
            <textarea id="additional_ppe" class="form-control" name="additional_ppe"></textarea>
            {{-- <button class="btn btn-primary" type="button"
